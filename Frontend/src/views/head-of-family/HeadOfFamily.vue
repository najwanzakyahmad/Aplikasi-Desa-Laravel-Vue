...
const relationLabel = (rel) =>
  RELATION_LABELS?.[String(rel || '').toLowerCase()] ?? (rel || '-')
        ...
        <div class="flex flex-col w-[calc(525/1000*100%)] shrink-0 gap-[14px]">
            <section id="Kepala-Rumah" class="flex flex-col rounded-3xl p-6 gap-6 bg-white">
                ...
                <div class="flex items-center w-full gap-3">
                    ...
                    <div class="flex flex-col gap-1 w-full">
                        <p class="font-semibold text-xl leading-[22.5px]">{{ calculateAge(headOfFamily?.birth_date) }} Tahun</p>
                        <span class="font-medium text-desa-secondary">
                            Umur Kepala Rumah
                        </span>
                    </div>
                ...
                <div class="flex items-center w-full gap-3">
                    ...
                    <div class="flex flex-col gap-1 w-full">
                        <p class="font-semibold text-xl leading-[22.5px] capitalize">{{ headOfFamily?.gender }}</p>
                        <span class="font-medium text-desa-secondary">
                            Jenis Kelamin
                        </span>
                    </div>
            ...
            <section id="Anggota-Keluarga" class="flex flex-col rounded-3xl p-6 gap-6 bg-white" v-if="headOfFamily.family_members?.length">
                <div class="flex items-center justify-between">
                    <div class="flex flex-col gap-[6px]">
                        <p class="font-semibold text-[32px] leading-10">{{ headOfFamily?.family_members?.length ?? 0  }}</p>
                    ...
                    <div class="card flex flex-col rounded-2xl border border-desa-background p-4 gap-6" v-for="familyMember in headOfFamily.family_members" :key="index">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-[6px] w-full">
                                ...
                                <p class="flex items-center gap-1">
                                    <img src="@/assets/images/icons/profile-2user-dark-green.svg" class="flex size-[18px] shrink-0" alt="icon">
                                    <span class="font-medium text-sm text-desa-secondary capitalize">Hubungan : {{ relationLabel(familyMember?.relation) }}</span>
                                </p>
                            </div>
                            <p class="font-medium leading-5 text-nowrap">{{ calculateAge(familyMember.birth_date) }} tahun</p>
                        </div>
