...
const { fetchSocialAssistances, fetchSocialAssistancesPaginated } = socialAssistanceStore
...
<template>
    <div id="Header" class="flex items-center justify-between">
        ...
        <RouterLink :to="{name: 'create-social-assistance'}" class="flex items-center rounded-2xl py-4 px-6 gap-[10px] bg-desa-dark-green">
    ...
    <section id="List-Bantuan-Sosial" class="flex flex-col gap-[14px]">
        ...
        <CardList v-for="socialAssistance in socialAssistances" :item="socialAssistance" :key="socialAssistance.id" v-if="!loading"/>
